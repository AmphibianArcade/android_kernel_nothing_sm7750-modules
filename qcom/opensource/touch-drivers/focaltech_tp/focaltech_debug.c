...
extern struct proc_dir_entry *proc_dir_touchpanel;
/*****************************************************************************
...
int fts_fwdbg_init(struct fts_ts_data *ts_data)
{
    ...
    dbg->proc_fwdbg = proc_create_data("diff_data", 0664, proc_dir_touchpanel, &fts_fwdbg_fops, dbg);
